...
export const fetchProfileImage = async () => {
  ...
  // use the prisma to get the user profile image
...
export async function createReviewAction(prevState: any, formData: FormData) {
  ...
  try {
    ...
    // this one is option becuase we seperate action for this features
    // use the sepearte function in the property id page to check the user equal to owner ....
    ...
    if (existingReview) {
      return { message: "You have already reviewed this property" };
    }
